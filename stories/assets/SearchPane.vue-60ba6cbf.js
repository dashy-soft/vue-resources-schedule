...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    const props = __props;
    const DocSearchData = () => __vitePreload(() => import("./search-docs-data-a5ae2cc1.js"), true ? ["./search-docs-data-a5ae2cc1.js","./vendor-7a101243.js"] : void 0, import.meta.url);
    function close() {
      emit("close");
    }
    const input = ref();
